...
function onCreate()
	...
	if not lowQuality then
		...
		makeLuaSprite('sky', 'philly/sky', -250, -130);
		setScrollFactor('sky', 0.1, 0.1);
	                   scaleObject('sky', 1.25, 1.25);
	end

		makeLuaSprite('Clouds', 'week 3/Clouds', math.random(100, -1950), math.random(-20, 20));
		setLuaSpriteScrollFactor('Clouds', 0.1, 0.1);
		setProperty('Clouds.velocity.x', math.random(5, 20));

makeLuaSprite('background city', 'week 3/background city', -200, -40);
	setScrollFactor('background city', 0.3, 0.3);

makeLuaSprite('city2', 'week 3/city2', -195, -45);
	setScrollFactor('city2', 0.3, 0.3);
	scaleObject('city2', 1.0, 1.0);
	
	makeLuaSprite('train', 'philly/train', 3000, 360);

	makeLuaSprite('street2', 'week 3/street2', -200, 20);
	...
	--windows
	for i = 0, 4 do
		makeLuaSprite('win'..i, 'week 3/win'..i, -195, -45);
...
precacheImage('week 3/Clouds');
precacheImage('week 3/background city');
precacheImage('week 3/city2');
precacheImage('week 3/street2');
precacheImage('week 3/win0');
precacheImage('week 3/win1');
precacheImage('week 3/win2');
precacheImage('week 3/win3');
precacheImage('week 3/win4');
...
function onEvent(n, v1, v2) -- Blammed Lights Recreation
	if n == 'Blammed Lights' then
		for i = 0, 5 do
			makeLuaSprite('light'..i, 'week 3/win'..i,-195, -45);
